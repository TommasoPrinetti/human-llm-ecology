...
## Purpose
This document aggregates all structured research needs chronologically. Lucrezio reads this as a single corpus to detect emerging patterns for research tendencies.
...
4. If any type reaches 3, trigger tendency registration (see `00_system/skills/LUCREZIO_SKILL.md`)
